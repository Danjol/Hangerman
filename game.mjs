...
async function pickRandomWordFromFile() {
    try {
...
async function playGame() {
    stats.gamesPlayed++;
    let correctWord = await pickRandomWordFromFile();
    ...
    while (!isGameOver) {
        ...
        if (ifPlayerGuessedLetter(answer) && allGuesses.has(answer)) {
            console.log(ANSI.COLOR.RED + "You've already guessed that letter. Try again!" + ANSI.RESET);
    ...
    const playAgain = (await askQuestion("Do you want to play again? (yes/no): ")).toLowerCase();
    if (playAgain === 'yes') {
        await playGame(); // Start a new game
    } else {
        displayStats();
        console.log("")
...
console.log("")
console.log("  ____   ____  ___ ___    ___       _____ ______   ____  ______  _____")
console.log(" /    | /    ||   |   |  /  _]     / ___/|      | /    ||      |/ ___/")
console.log("|   __||  o  || _   _ | /  [_     (   \_ |      ||  o  ||      (   \_ ")
console.log("|  |  ||     ||  \_/  ||    _]     \__  ||_|  |_||     ||_|  |_|\__  |")
console.log("|  |_ ||  _  ||   |   ||   [_      /  \ |  |  |  |  _  |  |  |  /  \ |")
console.log("|     ||  |  ||   |   ||     |     \    |  |  |  |  |  |  |  |  \    |")
console.log("|___,_||__|__||___|___||_____|      \___|  |__|  |__|__|  |__|   \___|")
console.log("")
console.log("-------------------------")
console.log("Games Played: " + stats.gamesPlayed);
console.log("Games Won: " + stats.gamesWon);
console.log("Correct Guesses: " + stats.totalCorrectGuesses);
